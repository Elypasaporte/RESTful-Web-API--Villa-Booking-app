...
namespace MagicVilla_Web.Controllers
{
    public class VillaNumberController : Controller
    {
        ...
        public async Task<IActionResult> IndexVillaNumber()
        {
            ...
            var response = await _villaNumberService.GetAllAsynce<APIResponse>(HttpContext.Session.GetString(SD.SessionToken));
        ...
        public async Task<IActionResult> CreateVillaNumber()
        {
            ...
            var response = await _villaService.GetAllAsynce<APIResponse>(HttpContext.Session.GetString(SD.SessionToken));
            if (response != null && response.IsSuccess)
            {
        ...
        public async Task<IActionResult> CreateVillaNumber(VillaNumberCreateVM model)
        {
            ...
            var resp = await _villaService.GetAllAsynce<APIResponse>(HttpContext.Session.GetString(SD.SessionToken));
        ...
        public async Task<IActionResult> UpdateVillaNumber(int villaNo)
        {
            ...
            if (response != null && response.IsSuccess)
            {
             ...
             response = await _villaService.GetAllAsynce<APIResponse>(HttpContext.Session.GetString(SD.SessionToken));
            if (response != null && response.IsSuccess)
            {
                villaNumberVM.VillaList = JsonConvert.DeserializeObject<List<VillaDTO>>
                    (Convert.ToString(response.Result)).Select(i => new SelectListItem
